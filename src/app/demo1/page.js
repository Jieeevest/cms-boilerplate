        ...
        <div className=" max-h-[800px] overflow-auto">
          ...
          <section className="mb-8 border-2 p-5 rounded-xl">
            ...
            <div className="flex gap-4">
              ...
              <Avatar
                ...
                status="success"
              />
              <Avatar src="/media/avatars/300-4.png" size="20" status="gray" />
              <Avatar
                initial="B"
                size="20"
          ...
          <section className="mb-8 border-2 p-5 rounded-xl">
            ...
            <div className="flex gap-4">
              ...
              <Badge text="Badge Outline" appearance="success" type="outline" />
          ...
          <section className="mb-8 border-2 p-5 rounded-xl">
            ...
            <p className="text-sm font-semibold my-4">Input Text Formatting</p>
